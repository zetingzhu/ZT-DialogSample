...
import com.zzt.dialogutilcode.layout.QMUIButton;
import com.zzt.dialogutilcode.layout.QMUILinearLayout;
import com.zzt.dialogutilcode.skin.QMUISkinHelper;
import com.zzt.dialogutilcode.util.QMUIDisplayHelper;
import com.zzt.dialogutilcode.util.QMUIDrawableHelper;
import com.zzt.dialogutilcode.util.QMUIResHelper;
import com.zzt.dialogutilcode.widget.QMUIWrapContentScrollView;
...
public abstract class QMUIDialogBuilder<T extends QMUIDialogBuilder> {
    private static final String TAG = QMUIDialogBuilder.class.getSimpleName();
...
//        mDialogView.setBackgroundColor(Color.BLUE);
        mDialogView.setPadding(130, 130, 130, 130);
...
//        dialogView.setBackground(QMUIResHelper.getAttrDrawable(context, R.attr.qmui_skin_support_dialog_bg));
        dialogView.setBackground(QMUIDrawableHelper.getVectorDrawable(context, R.color.qmui_config_color_pure_black));
//        dialogView.setRadius(QMUIResHelper.getAttrDimen(context, R.attr.qmui_dialog_radius));
//        skinConfigDialogView(dialogView);


//        dialogView.setBackgroundColor(Color.RED);
